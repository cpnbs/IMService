...
import com.cp.im.error.BussinessException;
import com.cp.im.error.ErrorCode;
import com.cp.im.feign.ExceptionFeign;
...
public class CommonExceptionAdvice {
    ...
    public Result handleMissingServletRequestParameterException(MissingServletRequestParameterException e) {
        ...
        return Result.error(ErrorCode.SERVER_IS_BUSY_515);
    }
    ...
    public Result handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
        ...
        return Result.error(ErrorCode.SERVER_IS_BUSY_516);
    }
    ...
    public Result handleMethodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        return Result.error(ErrorCode.SERVER_IS_BUSY_517);
    }
    ...
    public Result handleBindException(BindException e) {
        ...
        return Result.error(ErrorCode.SERVER_IS_BUSY_518);
    }
    ...
    public Result handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e) {
        ...
        return Result.error(ErrorCode.REQUEST_IS_NOT_SUPPORTED_519);
    }
    ...
    public Result handleHttpMediaTypeNotSupportedException(Exception e) {
        ...
        return Result.error(ErrorCode.SERVER_IS_BUSY_520);
    }
    ...
    public Result handleException(Exception e) {
        ...
        if (e instanceof NullPointerException) {
            ...
            msg = "SQL返回结果过多";
            code = "512";
        }else if (e instanceof PlayOrderException){
            msg = "订单消息发送失败";
            code = "513";
        }else if (e instanceof OCrUserException){
            return Result.error(ErrorCode.ERROR_USER_CARD);
        }
        try {
            if (!request.getRequestURL().toString().contains("exception")) {
        ...
        return Result.error(500, ErrorCode.SERVER_IS_BUSY.getMsg()+"（" + code + "）");
    }
    ...
    public Result handleException(DataIntegrityViolationException e) {
        ...
        return Result.error(ErrorCode.SERVER_IS_BUSY_514);
    }
    ...
    public Result handleException(RedisConnectionException e) {
        ...
        return Result.error(ErrorCode.SERVER_IS_BUSY_530);
    }
}
