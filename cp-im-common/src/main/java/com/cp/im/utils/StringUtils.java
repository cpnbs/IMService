...
public class StringUtils {
    ...
    /** 根据2019工信部公布的手机号码段. */
    private static final Pattern NEW_PATTERN_PHONE_1 = Pattern.compile("^(?:(?:\\+|00)86)?1(?:(?:3[\\d])|(?:4[5-79])|(?:5[0-35-9])|(?:6[5-7])|(?:7[0-8])|(?:8[\\d])|(?:9[189]))\\d{8}$");

    /** 只要开头是13、14、15、16、17、18、19即可. */
    private static final Pattern NEW_PATTERN_PHONE_2 = Pattern.compile("^(?:(?:\\+|00)86)?1[3-9]\\d{9}$");

    /** 只要开头是1即可. */
    private static final Pattern NEW_PATTERN_PHONE_3 = Pattern.compile("^(?:(?:\\+|00)86)?1\\d{10}$");

    private static final Pattern NEW_PATTERN_PHONE_4 = Pattern.compile("^1(?:34[0-8]|3[5-9]\\d|5[0-2,7-9]\\d|7[28]\\d|8[2-4,7-8]\\d|9[5,7,8]\\d|3[0-2]\\d|[578][56]\\d|66\\d|96\\d|33\\d|53\\d|7[37]\\d|8[019]\\d|9[0139]\\d|92\\d)\\d{7}$");

    private static final Pattern NEW_PATTERN_PHONE_5 = Pattern.compile("^(13[0-9]|14[01456879]|15[0-3,5-9]|16[2567]|17[0-8]|18[0-9]|19[0-3,5-9])d{8}$");

    private static final Pattern NEW_PATTERN_PHONE_6 = Pattern.compile("^1(3[0-9]|4[01456879]|5[0-3,5-9]|6[2567]|7[0-8]|8[0-9]|9[0-3,5-9])d{8}$");

    private static final Pattern NEW_PATTERN_PHONE_7 = Pattern.compile("^1(3\\d|4[5-9]|5[0-35-9]|6[2567]|7[0-8]|8\\d|9[0-35-9])\\d{8}$");
    ...
    public static Boolean isPhone(String phone) {
        ...
        if (NEW_PATTERN_PHONE_4.matcher(phone).matches()) {
            return true;
        }
        if (NEW_PATTERN_PHONE_5.matcher(phone).matches()) {
            return true;
        }
        if (NEW_PATTERN_PHONE_6.matcher(phone).matches()) {
            return true;
        }
        if (NEW_PATTERN_PHONE_7.matcher(phone).matches()) {
            return true;
        }
        return NEW_PATTERN_PHONE_1.matcher(phone).matches();
    }
    ...
    public static String repeat(final String component, final int times) {
        ...
        return IntStream.range(0, times).mapToObj(i -> component)
