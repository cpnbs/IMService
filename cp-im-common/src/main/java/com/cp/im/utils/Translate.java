...
public class Translate {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(getInstance().translateText("To start using Cloud Translation, you need a project that has the Cloud Translation API enabled and credentials to make authenticated calls. The following sections detail how to get set up before you make your first call to the Cloud Translation API.", "en", "zh"));
    }
